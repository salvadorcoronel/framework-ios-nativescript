#
#  Be sure to run `pod spec lint FramewokForNS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Salvador"
  # s.authors            = { "Salvador" => "scoronel@belatrixsf.com" }
  # s.social_media_url   = "http://twitter.com/Salvador"
